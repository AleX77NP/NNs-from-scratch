...
# backpropagation
def back_propagation(x, y, params, forward_cache):
    m = x.shape[1]
...
def model(x, y, n_h, alfa, iterations):
    ...
    for i in range(iterations):
        ...
        gradients = back_propagation(x, y, params, forward_cache)
...
if __name__ == '__main__':
    ...
    n_h = 1000
    alfa = 0.02
    parameters, cost_list = model(X_train, Y_train, n_h = n_h, alfa = alfa, iterations = iterations)
